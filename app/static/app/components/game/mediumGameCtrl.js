angular.module('minesweeperApp.mediumGameCtrl', [
    'ui.router',
    'ngRoute',
    'ngMaterial',
...
.controller('mediumGameCtrl', ['$scope', '$rootScope', '$http', '$state','$mdDialog', function($scope, $rootScope, $http, $state, $mdDialog) {
    ...
    const board = jsboard.board({attach: "game", size:"7x7"});
