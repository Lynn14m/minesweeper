angular.module('minesweeperApp.hardGameCtrl', [
    'ui.router',
    'ngRoute',
    'ngMaterial',
...
.controller('hardGameCtrl', ['$scope', '$rootScope', '$http', '$state','$mdDialog', function($scope, $rootScope, $http, $state, $mdDialog) {
    ...
    const board = jsboard.board({attach: "game", size:"9x9"});
